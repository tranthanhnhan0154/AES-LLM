...
def main():
    ...
    if num_leaked > 0:
        print(f"⚠️ Cảnh báo: Phát hiện {num_leaked} bài viết trong tập Train trùng với tập Test!")
        ...
        print("✔ Tuyệt vời! Không phát hiện rò rỉ dữ liệu giữa Train và Test.")
    ...
    try:
        ...
        print("\n🎉 CHÚC MỪNG: GIAI ĐOẠN 1 ĐÃ HOÀN THÀNH XUẤT SẮC!")
        print("="*60)
    except Exception as e:
